...
- **Inspect sections are shared between desktop and mobile** via a `compact` prop (`components/inspect/*`, barrel `components/inspect/index.ts`) — don't fork them per platform.
