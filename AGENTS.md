...
Default center: Seattle (47.6062, -122.3321, zoom 12). Default layers: `zoning`, `parks_open_space`, and `institutions` — parks and the institutions overlay both ride along with the zoning toggle in `MapContainer.handleBaseLayerChange` and are not independently user-toggleable.
